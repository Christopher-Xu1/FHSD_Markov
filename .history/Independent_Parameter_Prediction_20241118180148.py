...
# Assuming 'optimized_probabilities' is a dictionary with state names and probability arrays
...
headers = ['State'] + [f'Prob {i+1}' for i in range(len(next(iter(rounded_probabilities.values()))))]
